...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  struct FlagTraits<PipelineCreateFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PipelineCreateFlags allFlags =
      ...
      PipelineCreateFlagBits::eRenderingFragmentShadingRateAttachmentKHR | PipelineCreateFlagBits::eRenderingFragmentDensityMapAttachmentEXT |
  ...
  struct FlagTraits<PipelineCreateFlagBits2>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PipelineCreateFlags2 allFlags =
      ...
      PipelineCreateFlagBits2::eEarlyReturnOnFailure | PipelineCreateFlagBits2::eEnableLegacyDitheringEXT | PipelineCreateFlagBits2::eDeferCompileNV |
      PipelineCreateFlagBits2::eCaptureStatisticsKHR | PipelineCreateFlagBits2::eCaptureInternalRepresentationsKHR |
      ...
      PipelineCreateFlagBits2::eNoProtectedAccessEXT | PipelineCreateFlagBits2::eProtectedAccessOnlyEXT |
