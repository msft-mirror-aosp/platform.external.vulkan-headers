...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  VULKAN_HPP_INLINE std::string to_string( PipelineCreateFlags2 value )
  {
    ...
    if ( value & PipelineCreateFlagBits2::eDepthStencilAttachmentFeedbackLoopEXT )
      result += "DepthStencilAttachmentFeedbackLoopEXT | ";
    if ( value & PipelineCreateFlagBits2::eNoProtectedAccessEXT )
      result += "NoProtectedAccessEXT | ";
    if ( value & PipelineCreateFlagBits2::eProtectedAccessOnlyEXT )
  ...
  VULKAN_HPP_INLINE std::string to_string( PipelineCreateFlagBits2 value )
  {
    switch ( value )
    {
      ...
      case PipelineCreateFlagBits2::eNoProtectedAccessEXT: return "NoProtectedAccessEXT";
      case PipelineCreateFlagBits2::eProtectedAccessOnlyEXT: return "ProtectedAccessOnlyEXT";
